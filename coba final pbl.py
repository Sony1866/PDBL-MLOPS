...
best_model  = joblib.load(r'C:\Users\ASUS TUF\Documents\ML OPS\PRAKTIKUM\best_model_regresi.pkl')
...
def proses_pengajuan_lengkap(pipe_klasifikasi, threshold, model_regresi, input_user):
    ...
    data_regresi = {
        ...
        'BankcardUtilization'       : round(bankcard_util, 4),
        'AvailableBankcardCredit'   : sisa_limit,
        'MonthlyLoanPayment'        : input_user['sanggup_cicil_bulan'],
        'BorrowerRate'              : bunga,
    ...
    # Ambil nominal dari input (simulasi user pilih di UI)
...
input_nasabah_1 = {
    ...
    'lama_kerja_bulan'        : 48,
    'tujuan_pinjaman'         : 1,
    'nominal_dicairkan'       : 3000.0,  # minta $3,000 dari plafon yang ada
}
...
# Nasabah 3 - ACCEPT tapi minta melebihi plafon
input_nasabah_3 = {
    'borrower_state'          : 'NY',
    'occupation'              : 'Teacher',
    'gaji_bulanan'            : 4500.0,
