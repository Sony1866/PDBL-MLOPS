...
# =====================================================================
CSV_PATH       = r'/home/sony/Downloads/misah_dataset/prosperLoanData.csv'
...
def prediksi_nasabah_baru(model, input_nasabah: dict) -> dict:
    ...
    data_model = {
        ...
        'IsBorrowerHomeowner':               str(input_nasabah['Punya_Rumah']),
        'Occupation':                        str(input_nasabah.get('Jabatan', 'Other')),
        'StatedMonthlyIncome':               gaji,
        'IncomeVerifiable':                  str(input_nasabah.get('Penghasilan_Verifikasi', True)),
